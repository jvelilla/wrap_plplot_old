...
feature -- Initialization
	...
	make
		...
		local
			...
			cgrid1, cgrid2: PLC_GRID2
			l_dispatcher: PLTRANSFORM_DISPATCHER
		do
			...
			create cgrid1.make (XPTS, YPTS)
-- TODO check
--			cgrid1.set_xg_from_array (xg1, XPTS, YPTS)
--			cgrid1.set_yg_from_array (yg1, XPTS, YPTS)
			...
			plcol0( 2 )
			l_dispatcher.plcont( z, XPTS, YPTS, 1, XPTS, 1, YPTS, clevel, 11, Void )
			plstyl( 1, $mark, $space )
			plcol0( 3 )
			l_dispatcher.plcont( w, XPTS, YPTS, 1, XPTS, 1, YPTS, clevel, 11, Void )
			plstyl( 0, $mark, $space );
			plcol0( 1 );
		    ...
		    plenv( -1.0, 1.0, -1.0, 1.0, 0, 0 )
		    plcol0( 2 )
		    plcont( z, XPTS, YPTS, 1, XPTS, 1, YPTS, clevel, 11, pltr1_address, cgrid1 )
		    plstyl( 1, $mark, $space )
		    plcol0( 3 )
		    plcont( w, XPTS, YPTS, 1, XPTS, 1, YPTS, clevel, 11, pltr1_address, cgrid1 )
		    plstyl( 0, $mark, $space )
		    plcol0( 1 )
		    pllab( "X Coordinate", "Y Coordinate", "Streamlines of flow" )
		    ...
		    plenv( -1.0, 1.0, -1.0, 1.0, 0, 0 )
		    plcol0( 2 );
		    plcont( z, XPTS, YPTS, 1, XPTS, 1, YPTS, clevel, 11,  pltr2_address, cgrid2 )
		    plstyl( 1, $mark, $space )
		    plcol0( 3 )
		    plcont( w, XPTS, YPTS, 1, XPTS, 1, YPTS, clevel, 11, pltr2_address, cgrid2 )
		    plstyl( 0, $mark, $space )
		    plcol0( 1 )
		    pllab( "X Coordinate", "Y Coordinate", "Streamlines of flow" )
...
feature -- Transformation function
	...
	polar
		...
		do
			...
			plcont( z, RPTS, THETAPTS, 1, RPTS, 1, THETAPTS, lev, 10, pltr2_address, cgrid2 );
		    plcol0( 1 )
	...
	potential
		...
		do
			...
			if nlevelneg > 0 then
					-- Negative contours
				pllsty( 2 )
		        plcont( z, PRPTS, PTHETAPTS, 1, PRPTS, 1, PTHETAPTS, clevelneg, nlevelneg, pltr2_address, cgrid2);
			end

		    if  nlevelpos > 0 then
		        	-- Positive contours
		        pllsty( 1 )
		        plcont( z, PRPTS, PTHETAPTS, 1, PRPTS, 1, PTHETAPTS, clevelpos, nlevelpos, pltr2_address, cgrid2 );
		    end
