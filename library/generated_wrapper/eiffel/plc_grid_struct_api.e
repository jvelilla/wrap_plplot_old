...
feature {NONE} -- Implementation wrapper for struct PLcGrid
	...
	set_c_xg (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((PLcGrid*)$an_item)->xg =  (PLFLT_NC_FE_POINTER)$a_value
			]"
		ensure
	...
	set_c_yg (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((PLcGrid*)$an_item)->yg =  (PLFLT_NC_FE_POINTER)$a_value
			]"
		ensure
	...
	set_c_zg (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((PLcGrid*)$an_item)->zg =  (PLFLT_NC_FE_POINTER)$a_value
			]"
		ensure
	...
	set_c_nx (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((PLcGrid*)$an_item)->nx =  (PLINT)$a_value
			]"
		ensure
	...
	set_c_ny (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((PLcGrid*)$an_item)->ny =  (PLINT)$a_value
			]"
		ensure
	...
	set_c_nz (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((PLcGrid*)$an_item)->nz =  (PLINT)$a_value
			]"
		ensure
