...
inherit
	...
	PLPLOT_API
--	PLDEFINED_CALLBACK_DISPATCHER
--		rename
--			make as set_callback,
--			on_callback as zdefined,
--			c_dispatcher as zdefined_pointer
--		end
...
feature -- Initialization
	...
	make
		...
		do
			...
			plcol0( 2 );
			plcont( w, nx, ny, 1, nx, 1, ny, clevel, ns, pltr2_address, cgrid2 )
